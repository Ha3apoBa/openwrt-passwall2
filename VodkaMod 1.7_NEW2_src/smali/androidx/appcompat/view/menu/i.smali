...
.field public final i:Lcom/ejiaogl/tiktokhook/tb;

.field public final j:Landroidx/appcompat/view/menu/i$a;

.field public final k:Landroidx/appcompat/view/menu/i$b;
...
.method public constructor <init>(Landroid/content/Context;Landroidx/appcompat/view/menu/d;Landroid/view/View;IIZ)V
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/i;->j:Landroidx/appcompat/view/menu/i$a;
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/i;->k:Landroidx/appcompat/view/menu/i$b;
    ...
    iput-object p2, p0, Landroidx/appcompat/view/menu/i;->c:Landroidx/appcompat/view/menu/d;
    ...
    iput-object v1, p0, Landroidx/appcompat/view/menu/i;->d:Landroidx/appcompat/view/menu/c;
    ...
    new-instance p3, Lcom/ejiaogl/tiktokhook/tb;

    invoke-direct {p3, p1, p4, p5}, Lcom/ejiaogl/tiktokhook/tb;-><init>(Landroid/content/Context;II)V

    iput-object p3, p0, Landroidx/appcompat/view/menu/i;->i:Lcom/ejiaogl/tiktokhook/tb;
...
.method public final a(Landroidx/appcompat/view/menu/d;Z)V
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/i;->c:Landroidx/appcompat/view/menu/d;
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/i;->o:Landroidx/appcompat/view/menu/g$a;
...
.method public final b()V
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/i;->d:Landroidx/appcompat/view/menu/c;
...
.method public final c()Z
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/i;->i:Lcom/ejiaogl/tiktokhook/tb;
...
.method public final f()V
    ...
    invoke-virtual {v0, p0}, Lcom/ejiaogl/tiktokhook/ma;->k(Landroid/widget/PopupWindow$OnDismissListener;)V

    iget-object v0, p0, Landroidx/appcompat/view/menu/i;->i:Lcom/ejiaogl/tiktokhook/tb;

    .line 2
    iput-object p0, v0, Lcom/ejiaogl/tiktokhook/ma;->p:Landroid/widget/AdapterView$OnItemClickListener;

    .line 3
    invoke-virtual {v0}, Lcom/ejiaogl/tiktokhook/ma;->j()V
    ...
    iget-object v3, p0, Landroidx/appcompat/view/menu/i;->j:Landroidx/appcompat/view/menu/i$a;

    invoke-virtual {v4, v3}, Landroid/view/ViewTreeObserver;->addOnGlobalLayoutListener(Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;)V

    :cond_3
    iget-object v3, p0, Landroidx/appcompat/view/menu/i;->k:Landroidx/appcompat/view/menu/i$b;

    invoke-virtual {v0, v3}, Landroid/view/View;->addOnAttachStateChangeListener(Landroid/view/View$OnAttachStateChangeListener;)V

    iget-object v3, p0, Landroidx/appcompat/view/menu/i;->i:Lcom/ejiaogl/tiktokhook/tb;

    .line 4
    iput-object v0, v3, Lcom/ejiaogl/tiktokhook/ma;->o:Landroid/view/View;

    .line 5
    iget v0, p0, Landroidx/appcompat/view/menu/i;->t:I
    ...
    invoke-static {v0, v4, v5}, Lcom/ejiaogl/tiktokhook/sb;->m(Landroid/widget/ListAdapter;Landroid/content/Context;I)I
    ...
    invoke-virtual {v0, v4}, Lcom/ejiaogl/tiktokhook/ma;->h(I)V

    iget-object v0, p0, Landroidx/appcompat/view/menu/i;->i:Lcom/ejiaogl/tiktokhook/tb;

    invoke-virtual {v0}, Lcom/ejiaogl/tiktokhook/ma;->i()V

    iget-object v0, p0, Landroidx/appcompat/view/menu/i;->i:Lcom/ejiaogl/tiktokhook/tb;

    .line 8
    iget-object v4, p0, Lcom/ejiaogl/tiktokhook/sb;->a:Landroid/graphics/Rect;
    ...
    :goto_1
    iput-object v5, v0, Lcom/ejiaogl/tiktokhook/ma;->w:Landroid/graphics/Rect;
    ...
    iget-object v4, p0, Landroidx/appcompat/view/menu/i;->c:Landroidx/appcompat/view/menu/d;
    ...
    iget-object v6, p0, Landroidx/appcompat/view/menu/i;->c:Landroidx/appcompat/view/menu/d;
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/i;->d:Landroidx/appcompat/view/menu/c;

    invoke-virtual {v0, v2}, Lcom/ejiaogl/tiktokhook/ma;->g(Landroid/widget/ListAdapter;)V
...
.method public final i(Landroidx/appcompat/view/menu/j;)Z
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/i;->o:Landroidx/appcompat/view/menu/g$a;

    invoke-virtual {v0, v2}, Landroidx/appcompat/view/menu/f;->d(Landroidx/appcompat/view/menu/g$a;)V

    invoke-static {p1}, Lcom/ejiaogl/tiktokhook/sb;->u(Landroidx/appcompat/view/menu/d;)Z
    ...
    iget-object v3, v0, Landroidx/appcompat/view/menu/f;->j:Lcom/ejiaogl/tiktokhook/sb;

    if-eqz v3, :cond_0

    invoke-virtual {v3, v2}, Lcom/ejiaogl/tiktokhook/sb;->o(Z)V
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/i;->c:Landroidx/appcompat/view/menu/d;

    invoke-virtual {v2, v1}, Landroidx/appcompat/view/menu/d;->c(Z)V

    iget-object v2, p0, Landroidx/appcompat/view/menu/i;->i:Lcom/ejiaogl/tiktokhook/tb;

    .line 5
    iget v3, v2, Lcom/ejiaogl/tiktokhook/ma;->f:I

    .line 6
    iget-boolean v4, v2, Lcom/ejiaogl/tiktokhook/ma;->i:Z
    ...
    :cond_1
    iget v2, v2, Lcom/ejiaogl/tiktokhook/ma;->g:I
    ...
    .line 8
    invoke-static {v5}, Lcom/ejiaogl/tiktokhook/ni$d;->d(Landroid/view/View;)I
...
.method public final o(Z)V
    ...
    iput-boolean p1, v0, Landroidx/appcompat/view/menu/c;->c:Z
...
.method public final onDismiss()V
    ...
    iget-object v1, p0, Landroidx/appcompat/view/menu/i;->c:Landroidx/appcompat/view/menu/d;
    ...
    iget-object v1, p0, Landroidx/appcompat/view/menu/i;->j:Landroidx/appcompat/view/menu/i$a;
    ...
    iget-object v1, p0, Landroidx/appcompat/view/menu/i;->k:Landroidx/appcompat/view/menu/i$b;
...
.method public final q(I)V
    ...
    iput p1, v0, Lcom/ejiaogl/tiktokhook/ma;->f:I
...
.method public final t(I)V
    ...
    invoke-virtual {v0, p1}, Lcom/ejiaogl/tiktokhook/ma;->l(I)V
