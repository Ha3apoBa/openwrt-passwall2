...
.field public j:Lcom/ejiaogl/tiktokhook/sb;

.field public k:Landroid/widget/PopupWindow$OnDismissListener;

.field public final l:Landroidx/appcompat/view/menu/f$a;
...
.method public constructor <init>(Landroid/content/Context;Landroidx/appcompat/view/menu/d;Landroid/view/View;ZII)V
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/f;->l:Landroidx/appcompat/view/menu/f$a;
...
# virtual methods
.method public final a()Lcom/ejiaogl/tiktokhook/sb;
    .locals 14

    iget-object v0, p0, Landroidx/appcompat/view/menu/f;->j:Lcom/ejiaogl/tiktokhook/sb;
    ...
    invoke-virtual {v0, v1}, Lcom/ejiaogl/tiktokhook/sb;->l(Landroidx/appcompat/view/menu/d;)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/f;->l:Landroidx/appcompat/view/menu/f$a;

    invoke-virtual {v0, v1}, Lcom/ejiaogl/tiktokhook/sb;->r(Landroid/widget/PopupWindow$OnDismissListener;)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/f;->f:Landroid/view/View;

    invoke-virtual {v0, v1}, Lcom/ejiaogl/tiktokhook/sb;->n(Landroid/view/View;)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/f;->i:Landroidx/appcompat/view/menu/g$a;

    invoke-interface {v0, v1}, Landroidx/appcompat/view/menu/g;->g(Landroidx/appcompat/view/menu/g$a;)V

    iget-boolean v1, p0, Landroidx/appcompat/view/menu/f;->h:Z

    invoke-virtual {v0, v1}, Lcom/ejiaogl/tiktokhook/sb;->o(Z)V

    iget v1, p0, Landroidx/appcompat/view/menu/f;->g:I

    invoke-virtual {v0, v1}, Lcom/ejiaogl/tiktokhook/sb;->p(I)V

    .line 2
    iput-object v0, p0, Landroidx/appcompat/view/menu/f;->j:Lcom/ejiaogl/tiktokhook/sb;
...
.method public final d(Landroidx/appcompat/view/menu/g$a;)V
    .locals 1
    ...
    invoke-interface {v0, p1}, Landroidx/appcompat/view/menu/g;->g(Landroidx/appcompat/view/menu/g$a;)V
...
.method public final e(IIZZ)V
    ...
    invoke-virtual {p0}, Landroidx/appcompat/view/menu/f;->a()Lcom/ejiaogl/tiktokhook/sb;

    move-result-object v0

    invoke-virtual {v0, p4}, Lcom/ejiaogl/tiktokhook/sb;->s(Z)V
    ...
    .line 1
    invoke-static {p4}, Lcom/ejiaogl/tiktokhook/ni$d;->d(Landroid/view/View;)I
    ...
    :cond_0
    invoke-virtual {v0, p1}, Lcom/ejiaogl/tiktokhook/sb;->q(I)V

    invoke-virtual {v0, p2}, Lcom/ejiaogl/tiktokhook/sb;->t(I)V
    ...
    .line 4
    iput-object p4, v0, Lcom/ejiaogl/tiktokhook/sb;->a:Landroid/graphics/Rect;

    .line 5
    :cond_1
    invoke-interface {v0}, Lcom/ejiaogl/tiktokhook/lf;->f()V
