...
.method private d(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Context;
    ...
    iget-object p1, p0, Lc0/d;->a:Landroid/content/Context;
...
.method private g(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    invoke-direct {p0, p1, p2}, Lc0/d;->f(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    invoke-direct {p0, p2}, Lc0/d;->e(Landroid/net/Uri;)I
...
.method public bridge synthetic a(Ljava/lang/Object;IILs/d;)Lcom/bumptech/glide/load/engine/s;
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lc0/d;->c(Landroid/net/Uri;IILs/d;)Lcom/bumptech/glide/load/engine/s;
...
.method public bridge synthetic b(Ljava/lang/Object;Ls/d;)Z
    ...
    invoke-virtual {p0, p1, p2}, Lc0/d;->h(Landroid/net/Uri;Ls/d;)Z
...
.method public c(Landroid/net/Uri;IILs/d;)Lcom/bumptech/glide/load/engine/s;
    ...
    invoke-direct {p0, p1, p2}, Lc0/d;->d(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Context;

    move-result-object p2

    invoke-direct {p0, p2, p1}, Lc0/d;->g(Landroid/content/Context;Landroid/net/Uri;)I

    move-result p1

    iget-object p3, p0, Lc0/d;->a:Landroid/content/Context;

    invoke-static {p3, p2, p1}, Lc0/a;->b(Landroid/content/Context;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method public h(Landroid/net/Uri;Ls/d;)Z
    .locals 0
