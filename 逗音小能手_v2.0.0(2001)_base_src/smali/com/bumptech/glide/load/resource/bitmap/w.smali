...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/bumptech/glide/load/resource/bitmap/w;->d:Ljava/util/Set;
...
.method private static a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Landroid/graphics/Matrix;)V
    ...
    invoke-static {v1}, Lcom/bumptech/glide/load/resource/bitmap/w;->d(Landroid/graphics/Canvas;)V
    :try_end_0
...
.method public static b(Lv/d;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    .locals 7
    ...
    invoke-static {p1}, Lcom/bumptech/glide/load/resource/bitmap/w;->h(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap$Config;

    move-result-object v1

    invoke-interface {p0, p2, p3, v1}, Lv/d;->c(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;

    move-result-object p0

    invoke-static {p1, p0}, Lcom/bumptech/glide/load/resource/bitmap/w;->l(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;)V
...
.method public static c(Lv/d;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    .locals 3
    ...
    :cond_2
    invoke-static {p0, p1, p2, p3}, Lcom/bumptech/glide/load/resource/bitmap/w;->e(Lv/d;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
...
.method public static e(Lv/d;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    .locals 6
    ...
    invoke-interface {p0, v3, v4, v5}, Lv/d;->c(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
...
.method public static k(Lv/d;Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    .locals 4

    invoke-static {p2}, Lcom/bumptech/glide/load/resource/bitmap/w;->j(I)Z
    ...
    invoke-static {p2, v0}, Lcom/bumptech/glide/load/resource/bitmap/w;->i(ILandroid/graphics/Matrix;)V
    ...
    invoke-interface {p0, v1, v2, v3}, Lv/d;->c(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
