...
.method constructor <init>(Lw/h;Lw/a$a;Lx/a;Lx/a;Lx/a;Lx/a;Lcom/bumptech/glide/load/engine/p;Lcom/bumptech/glide/load/engine/m;Lcom/bumptech/glide/load/engine/a;Lcom/bumptech/glide/load/engine/i$b;Lcom/bumptech/glide/load/engine/i$a;Lcom/bumptech/glide/load/engine/v;Z)V
    .locals 11
    ...
    iput-object v8, v7, Lcom/bumptech/glide/load/engine/i;->c:Lw/h;

    new-instance v9, Lcom/bumptech/glide/load/engine/i$c;

    move-object v0, p2

    invoke-direct {v9, p2}, Lcom/bumptech/glide/load/engine/i$c;-><init>(Lw/a$a;)V
    ...
    invoke-direct/range {v0 .. v6}, Lcom/bumptech/glide/load/engine/i$b;-><init>(Lx/a;Lx/a;Lx/a;Lx/a;Lcom/bumptech/glide/load/engine/k;Lcom/bumptech/glide/load/engine/n$a;)V
    ...
    invoke-interface {p1, p0}, Lw/h;->e(Lw/h$a;)V

    return-void
.end method

.method public constructor <init>(Lw/h;Lw/a$a;Lx/a;Lx/a;Lx/a;Lx/a;Z)V
    .locals 14
...
.method private e(Ls/b;)Lcom/bumptech/glide/load/engine/n;
    ...
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/i;->c:Lw/h;

    invoke-interface {v0, p1}, Lw/h;->c(Ls/b;)Lcom/bumptech/glide/load/engine/s;
    ...
    invoke-direct/range {v1 .. v6}, Lcom/bumptech/glide/load/engine/n;-><init>(Lcom/bumptech/glide/load/engine/s;ZZLs/b;Lcom/bumptech/glide/load/engine/n$a;)V
...
.method private g(Ls/b;)Lcom/bumptech/glide/load/engine/n;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, p1}, Lcom/bumptech/glide/load/engine/a;->e(Ls/b;)Lcom/bumptech/glide/load/engine/n;
...
.method private h(Ls/b;)Lcom/bumptech/glide/load/engine/n;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p1}, Lcom/bumptech/glide/load/engine/i;->e(Ls/b;)Lcom/bumptech/glide/load/engine/n;
    ...
    invoke-virtual {v1, p1, v0}, Lcom/bumptech/glide/load/engine/a;->a(Ls/b;Lcom/bumptech/glide/load/engine/n;)V
...
.method private i(Lcom/bumptech/glide/load/engine/l;ZJ)Lcom/bumptech/glide/load/engine/n;
    ...
    :cond_0
    invoke-direct {p0, p1}, Lcom/bumptech/glide/load/engine/i;->g(Ls/b;)Lcom/bumptech/glide/load/engine/n;
    ...
    invoke-static {v0, p3, p4, p1}, Lcom/bumptech/glide/load/engine/i;->j(Ljava/lang/String;JLs/b;)V

    :cond_1
    return-object p2

    :cond_2
    invoke-direct {p0, p1}, Lcom/bumptech/glide/load/engine/i;->h(Ls/b;)Lcom/bumptech/glide/load/engine/n;
...
.method private static j(Ljava/lang/String;JLs/b;)V
    .locals 1
    ...
    invoke-static {p1, p2}, Lm0/f;->a(J)D
...
.method private l(Lcom/bumptech/glide/d;Ljava/lang/Object;Ls/b;IILjava/lang/Class;Ljava/lang/Class;Lcom/bumptech/glide/Priority;Lcom/bumptech/glide/load/engine/h;Ljava/util/Map;ZZLs/d;ZZZZLcom/bumptech/glide/request/f;Ljava/util/concurrent/Executor;Lcom/bumptech/glide/load/engine/l;J)Lcom/bumptech/glide/load/engine/i$d;
    .locals 20
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<R:",
    ...
    invoke-virtual {v3, v15, v12}, Lcom/bumptech/glide/load/engine/p;->a(Ls/b;Z)Lcom/bumptech/glide/load/engine/j;

    move-result-object v3

    if-eqz v3, :cond_1

    invoke-virtual {v3, v1, v2}, Lcom/bumptech/glide/load/engine/j;->e(Lcom/bumptech/glide/request/f;Ljava/util/concurrent/Executor;)V
    ...
    invoke-static {v2, v13, v14, v15}, Lcom/bumptech/glide/load/engine/i;->j(Ljava/lang/String;JLs/b;)V
    ...
    invoke-virtual/range {v3 .. v8}, Lcom/bumptech/glide/load/engine/i$b;->a(Ls/b;ZZZZ)Lcom/bumptech/glide/load/engine/j;
    ...
    invoke-virtual/range {v3 .. v19}, Lcom/bumptech/glide/load/engine/i$a;->a(Lcom/bumptech/glide/d;Ljava/lang/Object;Lcom/bumptech/glide/load/engine/l;Ls/b;IILjava/lang/Class;Ljava/lang/Class;Lcom/bumptech/glide/Priority;Lcom/bumptech/glide/load/engine/h;Ljava/util/Map;ZZZLs/d;Lcom/bumptech/glide/load/engine/DecodeJob$b;)Lcom/bumptech/glide/load/engine/DecodeJob;

    move-result-object v3

    iget-object v4, v0, Lcom/bumptech/glide/load/engine/i;->a:Lcom/bumptech/glide/load/engine/p;

    invoke-virtual {v4, v2, v1}, Lcom/bumptech/glide/load/engine/p;->c(Ls/b;Lcom/bumptech/glide/load/engine/j;)V
    ...
    invoke-virtual {v5, v1, v2}, Lcom/bumptech/glide/load/engine/j;->e(Lcom/bumptech/glide/request/f;Ljava/util/concurrent/Executor;)V
    ...
    invoke-static {v2, v6, v7, v4}, Lcom/bumptech/glide/load/engine/i;->j(Ljava/lang/String;JLs/b;)V
...
.method public declared-synchronized b(Lcom/bumptech/glide/load/engine/j;Ls/b;Lcom/bumptech/glide/load/engine/n;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, p2, p3}, Lcom/bumptech/glide/load/engine/a;->a(Ls/b;Lcom/bumptech/glide/load/engine/n;)V

    :cond_0
    iget-object p3, p0, Lcom/bumptech/glide/load/engine/i;->a:Lcom/bumptech/glide/load/engine/p;

    invoke-virtual {p3, p2, p1}, Lcom/bumptech/glide/load/engine/p;->d(Ls/b;Lcom/bumptech/glide/load/engine/j;)V
    :try_end_0
...
.method public c(Ls/b;Lcom/bumptech/glide/load/engine/n;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, p1}, Lcom/bumptech/glide/load/engine/a;->d(Ls/b;)V
    ...
    invoke-interface {v0, p1, p2}, Lw/h;->d(Ls/b;Lcom/bumptech/glide/load/engine/s;)Lcom/bumptech/glide/load/engine/s;
...
.method public declared-synchronized d(Lcom/bumptech/glide/load/engine/j;Ls/b;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, p2, p1}, Lcom/bumptech/glide/load/engine/p;->d(Ls/b;Lcom/bumptech/glide/load/engine/j;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public f(Lcom/bumptech/glide/d;Ljava/lang/Object;Ls/b;IILjava/lang/Class;Ljava/lang/Class;Lcom/bumptech/glide/Priority;Lcom/bumptech/glide/load/engine/h;Ljava/util/Map;ZZLs/d;ZZZZLcom/bumptech/glide/request/f;Ljava/util/concurrent/Executor;)Lcom/bumptech/glide/load/engine/i$d;
    .locals 24
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<R:",
    ...
    invoke-virtual/range {v0 .. v8}, Lcom/bumptech/glide/load/engine/m;->a(Ljava/lang/Object;Ls/b;IILjava/util/Map;Ljava/lang/Class;Ljava/lang/Class;Ls/d;)Lcom/bumptech/glide/load/engine/l;
    ...
    invoke-interface {v2, v1, v0}, Lcom/bumptech/glide/request/f;->c(Lcom/bumptech/glide/load/engine/s;Lcom/bumptech/glide/load/DataSource;)V
