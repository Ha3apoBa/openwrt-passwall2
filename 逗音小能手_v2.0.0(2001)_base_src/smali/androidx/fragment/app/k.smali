...
.method protected static d(Ljava/util/List;Landroid/view/View;)V
    ...
    invoke-static {p0, p1, v0}, Landroidx/fragment/app/k;->h(Ljava/util/List;Landroid/view/View;I)Z
    ...
    invoke-static {p0, v4, v0}, Landroidx/fragment/app/k;->h(Ljava/util/List;Landroid/view/View;I)Z
...
.method f(Ljava/util/ArrayList;Landroid/view/View;)V
    ...
    invoke-static {p2}, Li/j;->a(Landroid/view/ViewGroup;)Z
    ...
    invoke-virtual {p0, p1, v2}, Landroidx/fragment/app/k;->f(Ljava/util/ArrayList;Landroid/view/View;)V
...
.method j(Ljava/util/Map;Landroid/view/View;)V
    ...
    invoke-static {p2}, Li/i;->h(Landroid/view/View;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1, v2}, Landroidx/fragment/app/k;->j(Ljava/util/Map;Landroid/view/View;)V
...
.method o(Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    invoke-static {v3}, Li/i;->h(Landroid/view/View;)Ljava/lang/String;
    ...
    invoke-static {v3, v4}, Li/i;->z(Landroid/view/View;Ljava/lang/String;)V
...
.method s(Landroid/view/ViewGroup;Ljava/util/ArrayList;Ljava/util/Map;)V
    ...
    invoke-direct {v0, p0, p2, p3}, Landroidx/fragment/app/k$c;-><init>(Landroidx/fragment/app/k;Ljava/util/ArrayList;Ljava/util/Map;)V

    invoke-static {p1, v0}, Landroidx/fragment/app/l;->a(Landroid/view/View;Ljava/lang/Runnable;)Landroidx/fragment/app/l;
...
.method w(Landroid/view/View;Ljava/util/ArrayList;Ljava/util/Map;)V
    ...
    invoke-direct {v0, p0, p2, p3}, Landroidx/fragment/app/k$b;-><init>(Landroidx/fragment/app/k;Ljava/util/ArrayList;Ljava/util/Map;)V
...
.method x(Landroid/view/View;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/Map;)V
    ...
    invoke-static {v3, v5}, Li/i;->z(Landroid/view/View;Ljava/lang/String;)V
    ...
    :cond_3
    new-instance p5, Landroidx/fragment/app/k$a;
    ...
    invoke-direct/range {v0 .. v6}, Landroidx/fragment/app/k$a;-><init>(Landroidx/fragment/app/k;ILjava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;)V

    invoke-static {p1, p5}, Landroidx/fragment/app/l;->a(Landroid/view/View;Ljava/lang/Runnable;)Landroidx/fragment/app/l;
